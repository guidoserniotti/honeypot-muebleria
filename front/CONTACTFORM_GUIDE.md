...
-   **Cuidado:** Esta inyección intenta eliminar la tabla `contacts` completa.
...
-   **Cuidado:** Elimina TODOS los contactos (porque `1=1` es verdadero).
...
-   **NUNCA** uses estas técnicas en sistemas reales sin autorización explícita.
-   Esto viola leyes sobre acceso no autorizado a sistemas computacionales.
